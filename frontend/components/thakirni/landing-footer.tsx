          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#25d366] hover:scale-110 transition-all"
              >
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-black hover:scale-110 transition-all text-sm font-bold text-white"
              >
                𝕏
              </a>
              {/* LinkedIn */}
              <a
                ...
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#0077b5] hover:scale-110 transition-all"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-white">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {productLinks.map(({ href, ar, en }) => (
                <li key={en}>
                  <Link href={href} className="hover:text-indigo-600 dark:text-indigo-400 transition-colors">
                    {t(ar, en)}
                  </Link>
                </li>
              ))}

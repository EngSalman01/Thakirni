      ...
      <div className="flex flex-wrap gap-2.5">
        {chips.map((chip) => (
          <motion.button
            ...
            className="px-4 py-2 rounded-full bg-slate-100 dark:bg-white/[0.06] hover:bg-indigo-50 dark:hover:bg-indigo-950/60 text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm font-semibold transition-colors duration-150 border border-slate-200 dark:border-white/10 hover:border-indigo-300 dark:hover:border-indigo-700"
          >
            {chip}
          </motion.button>
        ))}

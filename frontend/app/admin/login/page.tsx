...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // 2. Check admin status using the now-authenticated client
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: "#fbf9f8" }}>
      ...
      >
        {/* Card */}
        <div className="rounded-2xl p-8 shadow-sm" style={{ background: "#fff", border: "1px solid rgba(0,0,0,0.07)" }}>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input name="email" type="email" placeholder="admin@example.com"
                  className="ps-10" dir="ltr" required autoComplete="email" />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input name="password" type={showPw ? "text" : "password"}
                  placeholder="••••••••" className="ps-10 pe-10" dir="ltr" required autoComplete="current-password" />
